  ...
  const state = {
    ...
    addTask: (newTask) => {
      if (newTask.type === "taskInterface") {
        _Storage__WEBPACK_IMPORTED_MODULE_0__.addItem(newTask.taskName, "task", newTask);
      }
    },
  };
...
/* harmony import */ var _TaskUI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TaskUI */ "./src/modules/TaskUI.js");
/* harmony import */ var _AddForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AddForm */ "./src/modules/AddForm.js");
...
/* harmony import */ var _ProjectForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ProjectForm */ "./src/modules/ProjectForm.js");
...
const getActiveProjectKey = () => _Storage__WEBPACK_IMPORTED_MODULE_5__.getItem("ActiveProject").projectKey;
  ...
  if (document.querySelector(".edit-input") === null) {
    ...
    inputTaskName.addEventListener("focusout", () => {
      if (inputTaskName.value !== "") {
        const project = _Storage__WEBPACK_IMPORTED_MODULE_5__.getItem(task.project);
        taskNameElement.innerText = inputTaskName.value;
        task.taskName = inputTaskName.value;
        project.taskList.tasks[index] = task;
        _Storage__WEBPACK_IMPORTED_MODULE_5__.updateItem(task.project, project);
      }
...
const getActiveProject = () => {
  const { projectKey } = _Storage__WEBPACK_IMPORTED_MODULE_5__.getItem("ActiveProject");
  const project = _Storage__WEBPACK_IMPORTED_MODULE_5__.getItem(projectKey);
  return project;
};
...
const renderTasks = (project) => {
  if (project !== null) {
    ...
    tasks.forEach((task, index) => {
      const taskUI = (0,_TaskUI__WEBPACK_IMPORTED_MODULE_2__["default"])(task);
...
const renderAllTasks = () => {
  removeAllTaskElement();
  const storeProjects = _Storage__WEBPACK_IMPORTED_MODULE_5__.getAllStoreObjects("project");
...
const setActiveProject = (key) => {
  if (_Storage__WEBPACK_IMPORTED_MODULE_5__.getItem("ActiveProject") !== null) {
    _Storage__WEBPACK_IMPORTED_MODULE_5__.updateItem("ActiveProject", { projectKey: key });
  } else {
    _Storage__WEBPACK_IMPORTED_MODULE_5__.addItem(
      "ActiveProject",
      "active_project",
      { projectKey: key },
...
const getDateInput = (taskDateInput) => {
  ...
  taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(
...
const addTask = () => {
  ...
  _Storage__WEBPACK_IMPORTED_MODULE_5__.updateItem(projectKey, activeProject);
  renderTasks(activeProject);
  _AddForm__WEBPACK_IMPORTED_MODULE_3__.toggleForm();
  console.log(newTask);
};
...
const toggleCompletion = (storageProject) => {
  ...
  _Storage__WEBPACK_IMPORTED_MODULE_5__.updateItem(key, project);
  removeAllProjectUI();
  loadAllProjects();
};
const renderProject = (storageProject) => {
  ...
  const projectUI = (0,_ProjectUI__WEBPACK_IMPORTED_MODULE_6__["default"])(
  ...
  projectUI.querySelector(".delete-button").addEventListener("click", () => {
    _Storage__WEBPACK_IMPORTED_MODULE_5__.removeItem(storageProject.key);
    projectUI.remove();
    renderAllTasks();
  });
  projectUI
...
const loadAllProjects = () => {
  ...
  const storeProjects = _Storage__WEBPACK_IMPORTED_MODULE_5__.getAllStoreObjectsWithKeys("project");
...
const addProject = (projectName) => {
  ...
  const project = (0,_Project__WEBPACK_IMPORTED_MODULE_4__["default"])(projectName, (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])());
  const storageProject = _Storage__WEBPACK_IMPORTED_MODULE_5__.addItem(
    projectName,
    project,
    "project",
  ...
  _ProjectForm__WEBPACK_IMPORTED_MODULE_7__.toggleForm();
};
  ...
  if (document.querySelector(".edit-input") === null) {
    ...
    inputProjectName.addEventListener("focusout", () => {
      ...
      if (inputProjectName.value !== "") {
        ...
        _Storage__WEBPACK_IMPORTED_MODULE_5__.removeItem(projectKey);
      }
...
const initEventListeners = () => {
  window.addEventListener("click", (e) => {
    if (!document.querySelector(".project-header").contains(e.target)) {
      _ProjectForm__WEBPACK_IMPORTED_MODULE_7__.closeForm();
    }
  });
...
const initializeDefaultProject = () => {
  if (_Storage__WEBPACK_IMPORTED_MODULE_5__.getStoreObject("DefaultProject").identifier !== "project") {
    _Storage__WEBPACK_IMPORTED_MODULE_5__.removeItem("DefaultProject");
  }
  if (_Storage__WEBPACK_IMPORTED_MODULE_5__.getItem("DefaultProject") !== null) {
    setActiveProject("DefaultProject");
  } else {
    const defaultProject = (0,_Project__WEBPACK_IMPORTED_MODULE_4__["default"])("DefaultProject", (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])(), false);
    _Storage__WEBPACK_IMPORTED_MODULE_5__.addItem(
      "DefaultProject",
      "project",
      defaultProject,
...
const initializeDummyProject = () => {
  if (_Storage__WEBPACK_IMPORTED_MODULE_5__.getItem("DummyProject") === null) {
    const dummyProject = (0,_Project__WEBPACK_IMPORTED_MODULE_4__["default"])("DummyProject", (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])(), false);
    _Storage__WEBPACK_IMPORTED_MODULE_5__.addItem("DummyProject", "project", dummyProject, "Project Exist!");
  }
};

const loadHomePage = () => {
  _AddForm__WEBPACK_IMPORTED_MODULE_3__.createForm();
  renderAllTasks();
  initEventListeners();
