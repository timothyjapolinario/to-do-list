...
/* harmony export */   "getAllStoreObjects": () => (/* binding */ getAllStoreObjects),
/* harmony export */   "getAllStoreObjectsWithKeys": () => (/* binding */ getAllStoreObjectsWithKeys),
    ...
    let state = {
        ...
        addTask: (newTask) => {
            if(newTask.type == "taskInterface"){
                _Storage_js__WEBPACK_IMPORTED_MODULE_0__.addItem(newTask.taskName,"task",newTask)
            }
        },
        getAllTask: () =>{
            return task
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (generateTaskUI);
...
/* harmony import */ var _TaskUI_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TaskUI.js */ "./src/modules/TaskUI.js");
/* harmony import */ var _AddForm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./AddForm.js */ "./src/modules/AddForm.js");
/* harmony import */ var _Project_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Project.js */ "./src/modules/Project.js");
/* harmony import */ var _Storage_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Storage.js */ "./src/modules/Storage.js");
/* harmony import */ var _ProjectUI__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ProjectUI */ "./src/modules/ProjectUI.js");
/* harmony import */ var _ProjectForm_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ProjectForm.js */ "./src/modules/ProjectForm.js");
...
const loadHomePage = () => {
    //localStorage.clear()
    _AddForm_js__WEBPACK_IMPORTED_MODULE_3__.createForm()
    renderAllTasks()
    initEventListeners()
...
const initializeDefaultProject = () =>{
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("DefaultProject")!==null){
        setActiveProject("DefaultProject")
    }else{
        const defaultProject = (0,_Project_js__WEBPACK_IMPORTED_MODULE_4__["default"])("DefaultProject", (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])(), false)
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem("DefaultProject", "default-project", defaultProject, "Project Exist!")
        setActiveProject("DefaultProject")
    }
}
const initializeAllTaskProject = () =>{
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("AllTaskProject")!==null){
        setActiveProject("AllTaskProject")
    }else{
        const defaultProject = (0,_Project_js__WEBPACK_IMPORTED_MODULE_4__["default"])("AllTaskProject", (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])(), false)
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem("AllTaskProject", "all-task-project", defaultProject, "Project Exist!")
        setActiveProject("AllTaskProject")
    }
}
const initializeDummyProject = () =>{
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("DummyProject")===null){
        const dummyProject = (0,_Project_js__WEBPACK_IMPORTED_MODULE_4__["default"])("DummyProject", (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])(), false)
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem("DummyProject", "project", dummyProject, "Project Exist!")
    }
}
...
const initEventListeners = () =>{
    ...
    addFormButton.forEach(button =>{
        button.addEventListener('click',_AddForm_js__WEBPACK_IMPORTED_MODULE_3__.toggleForm)
    })
    const addProjectButton = document.querySelector(".add-project-button")
    addProjectButton.addEventListener('click',()=>{
        _ProjectForm_js__WEBPACK_IMPORTED_MODULE_7__.toggleForm()
    })
...
const addProject = (projectName)=>{
    ...
    const project = (0,_Project_js__WEBPACK_IMPORTED_MODULE_4__["default"])(projectName, (0,_TaskList__WEBPACK_IMPORTED_MODULE_1__["default"])())
    const storageProject = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem(projectName, "project", project, "Error Adding New Project")
...
const renderProject = (storageProject)=>{
    ...
    const projectUI = (0,_ProjectUI__WEBPACK_IMPORTED_MODULE_6__["default"])(storageProject.object, storageProject.key)
    ...
    projectUI.querySelector('.delete-button').addEventListener('click',()=>{
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.removeItem(storageProject.key)
        projectUI.remove()
        renderAllTasks()
    })
...
const getActiveProjectKey = ()=>{
    return _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem('ActiveProject').projectKey
}
...
const toggleCompletion = (storageProject) =>{
    ...
    _Storage_js__WEBPACK_IMPORTED_MODULE_5__.updateItem(key, project)
    removeAllProjectUI()
    loadAllProjects()
}
...
const loadAllProjects = () =>{
    ...
    const storeProjects = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getAllStoreObjectsWithKeys('project')
...
const setActiveProject = (key) =>{
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("ActiveProject")!==null){
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.updateItem("ActiveProject", {projectKey: key})
    }else{
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem("ActiveProject","active_project",{projectKey: key},"Active Project Exist!")
    }
}
const renderAllImportantTask = ()=>{
    removeAllTaskElement()
    const storeProjects = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getAllStoreObjects('project')
    storeProjects.forEach(storeProject=>{
         storeProject.object.taskList.tasks.forEach(task=>{
            ...
            if(task.important){
                ...
                taskListUI.appendChild((0,_TaskUI_js__WEBPACK_IMPORTED_MODULE_2__["default"])(task)) 
            }
         })
    })
}
const renderAllTasks = ()=>{
    removeAllTaskElement()
   const storeProjects = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getAllStoreObjects('project')
   const defaultProject = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem('DefaultProject')
   storeProjects.forEach(storeProject=>{
        storeProject.object.taskList.tasks.forEach((task,index)=>{
            const taskListUI = document.querySelector('.task-list')
            const taskUI = (0,_TaskUI_js__WEBPACK_IMPORTED_MODULE_2__["default"])(task)
...
const renderTasks = (project)=>{
    if(project !== null){
        ...
        tasks.forEach((task,index)=>{
            let taskUI = (0,_TaskUI_js__WEBPACK_IMPORTED_MODULE_2__["default"])(task)
            taskListUI.appendChild(taskUI)
            const taskNameUI = taskUI.querySelector('.task-name')
            taskNameUI.addEventListener('dblclick', ()=>{
                editTaskName(task,index,taskNameUI)
...
const toggleTaskImportance = (task,index, element) =>{
    console.log("lol")
    const project = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem(task.project)
    if(task.important){
    ...
    _Storage_js__WEBPACK_IMPORTED_MODULE_5__.updateItem(task.project, project)
    console.log(project)
}
const editProjectName = (projectKey, element) =>{
    const project = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem(projectKey)
    ...
    if(document.querySelector(".edit-input") === null){
        ...
        inputProjectName.addEventListener('focusout', ()=>{
            ...
            if(inputProjectName.value != ""){
                ...
                console.log(project.projectName)
                _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem(inputProjectName.value, 'project', project, "Error updating project")
                _Storage_js__WEBPACK_IMPORTED_MODULE_5__.removeItem(projectKey)
            }
...
const addTask = () =>{
    ...
    const projectKey = _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem('ActiveProject').projectKey
    ...
    const newTask = (0,_Task__WEBPACK_IMPORTED_MODULE_0__["default"])(taskName, taskDescription, getDateInput(taskDateInput) , isImportant, activeProject.projectName)
    activeProject.taskList.tasks.push(newTask)
    allTaskProject.taskList.tasks.push(newTask)
    _Storage_js__WEBPACK_IMPORTED_MODULE_5__.updateItem(projectKey, activeProject)
    _Storage_js__WEBPACK_IMPORTED_MODULE_5__.updateItem("AllTaskProject", allTaskProject)
    renderTasks(activeProject)
    _AddForm_js__WEBPACK_IMPORTED_MODULE_3__.toggleForm();
    console.log(newTask)
}
const getDefaultProject = ()=>{
    return _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("DefaultProject")
}
const getAllTaskProject = ()=>{
    return _Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("AllTaskProject")
}
const getDateInput = (taskDateInput) =>{
    ...
    const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(taskDateInputInt[0], taskDateInputInt[1], taskDateInputInt[2]), 'MM/dd/yyyy')
    return taskDate
}
