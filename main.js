...
/* harmony export */   "getStoreObject": () => (/* binding */ getStoreObject),
...
const initializeDefaultProject = () =>{
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getStoreObject("DefaultProject").identifier != "project"){
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.removeItem("DefaultProject")
    }
    if(_Storage_js__WEBPACK_IMPORTED_MODULE_5__.getItem("DefaultProject")!==null){
        ...
        _Storage_js__WEBPACK_IMPORTED_MODULE_5__.addItem("DefaultProject", "project", defaultProject, "Project Exist!")
        setActiveProject("DefaultProject")
    }
}
...
const initEventListeners = () =>{
    window.addEventListener('click', function(e){   
        if (!document.querySelector('.project-header').contains(e.target)){
          _ProjectForm_js__WEBPACK_IMPORTED_MODULE_7__.closeForm()
        }
      });
